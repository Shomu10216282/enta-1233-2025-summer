...
#endif
    public class VangardController : MonoBehaviour
    {
        [Header("Player")]
        ...
        [SerializeField] private GameObject PlayerAimCamera;
        ...
        [Tooltip("Set values from the input system")]
        [SerializeField] private VangardInputs Input;
        ...
        private void Start()
        {
            ...
            _input = GetComponent<VangardInputs>();
#if ENABLE_INPUT_SYSTEM
        ...
        private void CheckAim()
        {
            if (PlayerAimCamera != null)
                PlayerAimCamera.gameObject.SetActive(Input.Aim);
        }
